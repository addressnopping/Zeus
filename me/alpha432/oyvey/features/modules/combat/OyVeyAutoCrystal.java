...
public class OyVeyAutoCrystal extends Module {
  ...
  public Setting<Boolean> ecmeplace = register(new Setting("1.13 Place", Boolean.valueOf(true)));
  ...
  public Setting<Boolean> removeAttack = register(new Setting("EntityRemove", Boolean.valueOf(false)));
  ...
  public OyVeyAutoCrystal() {
    super("AutoCrystal", "Non phobos", Module.Category.COMBAT, true, false, false);
  }
  ...
  public void onPacketSend(PacketEvent.Send event) {
    ...
    if (event.getStage() == 0 && event.getPacket() instanceof CPacketUseEntity) {
      ...
      if (((Boolean)this.removeAttack.getValue()).booleanValue()) {
        packet.getEntityFromWorld((World)mc.world).setDead();
  ...
  public void onRender3D(Render3DEvent event) {
    if (this.pos != null && ((Boolean)this.render.getValue()).booleanValue() && this.target != null) {
      ...
      if (((Boolean)this.renderDmg.getValue()).booleanValue()) {
        ...
        RenderUtil.drawText(this.pos, ((Math.floor(renderDamage) == renderDamage) ? (String)Integer.valueOf((int)renderDamage) : String.format(ChatFormatting.WHITE + "%.1f", new Object[] { Double.valueOf(renderDamage) })) + "");
      } 
    } 
  }
