...
public class ConfigManager implements Util {
  ...
  public String config = "zeus/config/";
  ...
  public void loadConfig(String name) {
    List<File> files = (List<File>)Arrays.<Object>stream((Object[])Objects.requireNonNull((new File("zeus")).listFiles())).filter(File::isDirectory).collect(Collectors.toList());
    if (files.contains(new File("zeus/" + name + "/"))) {
      this.config = "zeus/" + name + "/";
    } else {
      this.config = "zeus/config/";
    } 
  ...
  public boolean configExists(String name) {
    List<File> files = (List<File>)Arrays.<Object>stream((Object[])Objects.requireNonNull((new File("zeus")).listFiles())).filter(File::isDirectory).collect(Collectors.toList());
    return files.contains(new File("zeus/" + name + "/"));
  }
