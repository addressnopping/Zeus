...
final class Item {
  ...
  void set(int type, String strVal1, String strVal2, String strVal3) {
    ...
    switch (type) {
      ...
      case 12:
        this
          .hashCode = Integer.MAX_VALUE & type + strVal1.hashCode() * strVal2.hashCode();
        return;
    } 
    this
      .hashCode = Integer.MAX_VALUE & type + strVal1.hashCode() * strVal2.hashCode() * strVal3.hashCode();
  }
  ...
  void set(String name, String desc, int bsmIndex) {
    ...
    this.strVal2 = desc;
    this
      .hashCode = Integer.MAX_VALUE & 18 + bsmIndex * this.strVal1.hashCode() * this.strVal2.hashCode();
  }
  ...
  boolean isEqualTo(Item i) {
    switch (this.type) {
      ...
      case 18:
        return (i.longVal == this.longVal && i.strVal1.equals(this.strVal1) && i.strVal2
          .equals(this.strVal2));
    } 
    return (i.strVal1.equals(this.strVal1) && i.strVal2.equals(this.strVal2) && i.strVal3
      .equals(this.strVal3));
  }
}
