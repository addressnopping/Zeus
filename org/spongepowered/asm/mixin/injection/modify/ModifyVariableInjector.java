...
public class ModifyVariableInjector extends Injector {
  ...
  private void printLocals(Context context) {
    ...
    (new PrettyPrinter())
      ...
      .kv("Instruction", "%s %s", new Object[] { context.node.getClass().getSimpleName(), Bytecode.getOpcodeName(context.node.getOpcode()) }).hr()
      ...
      .kv("Match index", (this.discriminator.getIndex() < context.baseArgIndex) ? "any" : Integer.valueOf(this.discriminator.getIndex()))
