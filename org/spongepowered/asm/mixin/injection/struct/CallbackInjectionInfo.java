...
public class CallbackInjectionInfo extends InjectionInfo {
  ...
  protected Injector parseInjector(AnnotationNode injectAnnotation) {
    ...
    LocalCapture locals = (LocalCapture)Annotations.getValue(injectAnnotation, "locals", LocalCapture.class, (Enum)LocalCapture.NO_CAPTURE);
    String identifier = (String)Annotations.getValue(injectAnnotation, "id", "");
    return (Injector)new CallbackInjector(this, cancellable, locals, identifier);
  }
