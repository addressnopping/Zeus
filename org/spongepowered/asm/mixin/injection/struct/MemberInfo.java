...
public final class MemberInfo {
  ...
  public boolean matches(String owner, String name, String desc) {
    return matches(owner, name, desc, 0);
  }
  ...
  public boolean matches(String name, String desc) {
    return matches(name, desc, 0);
  }
  
  public boolean matches(String name, String desc, int ordinal) {
    return ((this.name == null || this.name.equals(name)) && (this.desc == null || (desc != null && desc
      .equals(this.desc))) && (ordinal == 0 || this.matchAll));
  }
