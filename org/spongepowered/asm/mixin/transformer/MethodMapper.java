...
public class MethodMapper {
  ...
  public String getHandlerName(MixinInfo.MixinMethodNode method) {
    ...
    return String.format("%s$%s$%s%s", new Object[] { prefix, method.name, classUID, methodUID });
  }
  ...
  private static String getMethodUID(String name, String desc, boolean increment) {
    String descriptor = String.format("%s%s", new Object[] { name, desc });
    ...
    return String.format("%03x", new Object[] { Integer.valueOf(id.value) });
  }
